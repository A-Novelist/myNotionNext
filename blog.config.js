...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '诗远', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '三年嵌入式全栈工程师👌', // 作者简介
  BIO: process.env.NEXT_PUBLIC_BIO || '· 青年软件工程师👌', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://chuangjingtech.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '科技美学 创无止境', // 网站关键词 英文逗号隔开
